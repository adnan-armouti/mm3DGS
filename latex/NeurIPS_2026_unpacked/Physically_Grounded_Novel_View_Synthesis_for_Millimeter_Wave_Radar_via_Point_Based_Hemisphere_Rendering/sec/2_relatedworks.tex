...
\toprule
\textbf{Method} & \textbf{Repr.} & \textbf{Signal} & \textbf{Complex} & \textbf{Diff.} & \textbf{Mat.} & \textbf{Per-pt} & \textbf{BSDF} & \textbf{NVS} & \textbf{Real} & \textbf{Pts/iter} \\
\midrule
...
mmIR~\cite{mmIR2026}                 & Mesh    & ADC & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & --         & \checkmark & 24k    \\
\midrule
DART~\cite{huang2024dart}            & NeRF    & RA  & --         & \checkmark & --         & --         & --         & \checkmark & \checkmark & --     \\
Radar Fields~\cite{10.1145/3641519.3657510} & NeRF & RA & --      & \checkmark & --         & --         & --         & \checkmark & \checkmark & --     \\
SpINR~\cite{takawale2025spinr}       & NeRF    & RA  & --         & \checkmark & --         & --         & --         & \checkmark & \checkmark & --     \\
RadarSplat~\cite{kung2025radarsplat} & 3DGS    & RA  & --         & \checkmark & --         & --         & --         & \checkmark & \checkmark & --     \\
\midrule
mm3DGS (Ours)                        & Points  & ADC & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & 90k    \\
\bottomrule
\end{tabular}
}
\end{table}
