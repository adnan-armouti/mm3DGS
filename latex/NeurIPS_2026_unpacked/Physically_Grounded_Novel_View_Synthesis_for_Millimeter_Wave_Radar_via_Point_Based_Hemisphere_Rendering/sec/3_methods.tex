% =====================================================================
% NOTE TO AUTHOR (please review): the abstract / intro currently quote
% "9 frames, train 7, hold out 2" and "90k points / 30-40s per scene".
% The implementation in mm25DGS_v5_v4/ uses N=20,000 oriented points,
% 9 cascaded frames per scene, trains on 8 frames bracketing 1 held-out
% test frame (chirp 0 only), and converges in ~136s per scene. The
% Methods + Results below match the ACTUAL implementation and should be
% reconciled with the abstract/intro before submission.
% =====================================================================
