...
Usage:
    ...
    python -m mm25DGS_v5.chirp_loop_sweep --mode upper_bound --gpu 0

    # All target scenes, held_out loop 8, GPU 1
    python -m mm25DGS_v5.chirp_loop_sweep --mode held_out --gpu 1
...
OUTPUT_ROOT = os.path.join(PROJECT_ROOT, 'mm25DGS_v5', 'output_chirp_loop')
...
def run_experiment(scene, frame, mode, gpu, iters, held_out_loop,
    ...
    cmd = [
        sys.executable, '-m', 'mm25DGS_v5.train_chirp_loop_nvs',
