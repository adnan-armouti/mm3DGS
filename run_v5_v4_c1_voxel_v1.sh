#!/usr/bin/env bash
# M3: bench C1_voxel_v1 init across 6 scenes. All other knobs at v5_v4
# default (combo_jitter recipe, M0 tightened FOV).
set -u
cd /home/adnan/Desktop/mm3DGS
PY=/home/adnan/.conda/envs/mmir/bin/python
export PYTHONUNBUFFERED=1
LOG=/home/adnan/Desktop/mm3DGS/logs_v5_v4/c1_voxel_v1_6scene
mkdir -p "$LOG"
