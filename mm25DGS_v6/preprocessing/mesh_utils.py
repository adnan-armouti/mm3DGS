...
def reconstruct_mesh_from_scene(scene_npy_path: str,
    ...
    if repo_root is None:
        # The copy lives at mm25DGS_v6/preprocessing/mesh_utils.py (one
        # level deeper than the mmir original), so parents[2] — not
        # parents[3] as in the original — resolves to the project root
        # where third_party/PoissonRecon lives.
