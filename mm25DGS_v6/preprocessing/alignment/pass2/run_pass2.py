...
Usage::
    ...
    python -m mm25DGS_v5.preprocessing.alignment.pass2.run_pass2 --all
"""
import os
import sys
import json
...
try:
    from mm25DGS_v5.preprocessing.alignment.cascaded_lidar_gpu import (
        optimize_alignment_gpu_with_prior, HAS_CUPY as LIDAR_GPU_HAS_CUPY,
    )
    from mm25DGS_v5.preprocessing.alignment.cascaded_lidar import (
