...
Skipped by default because it takes ~20 minutes. Run explicitly:
    CUDA_VISIBLE_DEVICES=1 /home/adnan/.conda/envs/mmir/bin/python \
        -m pytest mm25DGS_v5/cuda/tests/test_phase_f_all_scenes.py -m slow -s
"""
import time
...
from mm25DGS_v5.load_pretrained import SCENES
...
def _train(scene, use_cuda_kernels):
    import mm25DGS_v5.rasterizer_factorized as rf
    from mm25DGS_v5.train_gaussian import train_gaussians
