#!/usr/bin/env bash
# MLP-A v3: NeRF-style positional encoding L=4 on pose_6d.
# pose input dim = 6*(1+8) = 54. Helps smooth interpolation across train poses.
set -u
cd /home/adnan/Desktop/mm3DGS
PY=/home/adnan/.conda/envs/mmir/bin/python
export PYTHONUNBUFFERED=1
LOG=/home/adnan/Desktop/mm3DGS/logs_v5_v4/mlpa_pe4_6scene
mkdir -p "$LOG"
run_one() {
