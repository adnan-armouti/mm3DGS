...
Captures:
  1. Per-stage timings of render_factorized at target_n=90K on scene 135,
     dumped to mm25DGS_v5_v4/output/baseline_stage_times.json.
  2. A snapshot of key intermediate tensors (inputs + outputs of Step 4)
     saved to mm25DGS_v5_v4/output/kernel_validation/reference_forward.npz
...
from mm25DGS_v5_v4 import rasterizer_factorized as rf
...
def main():
    ...
    out_dir = os.path.join(PROJECT_ROOT, "mm25DGS_v5_v4", "output")
