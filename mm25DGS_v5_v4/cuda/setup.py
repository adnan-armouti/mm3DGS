"""Build the mm25DGS_v5_v4 CUDA extension.

Usage:
  cd mm25DGS_v5_v4/cuda && /home/adnan/.conda/envs/mmir/bin/python setup.py build_ext --inplace
...
setup(
    name='mm25dgs_v5_cuda',
    version='0.1.0',
    description='mm25DGS_v5_v4 CUDA kernels (fused BSDF + scatter splat)',
    ext_modules=[ext],
